...
- **Organização**: Diretórios numerados (ex: `1.primeiros-passos/`, `2.essenciais/`)
...
│   └── ...
└── 2.essenciais/              # Conteúdo essencial
...
- `tags`: Palavras-chave associadas ao conteúdo
...
5. **Tags**: Ajudam a categorizar o conteúdo
...
- **Use as tags**: Para entender objeto de cada prompt
- **Considere o contexto do diretório**: Arquivos em `primeiros-passos/` são introdutórios

### 2. Processamento de Código

- **Identifique a linguagem**: O nome após os backticks indica a sintaxe que deve ser relacioanda com os anexos do prompt
...
5. **Mantenha o contexto**: Relacione informações com o documento e seção atual
...
- **Tags**: Do frontmatter `tags` relacionadas ao conteúdo do prompt
...
2. **Busque em títulos, descrições e tags** primeiro
